...
/* Generate random numbers, the even/odd comparison is have a variety of numbers */
...
/* WIP--> working on indenting the text in 3 calculated columns */
void print_ray(int ray[], int size)
{
	int format = size / 3;	// 1/3 sections
	int mid_format = format * 2; // 2/3 sections
	int last_format = format * 3; // 3/3 sections
...
int main(int argc, char const *argv[])
{
	...
	scanf("%s", usr_input);#include <string.h>
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
